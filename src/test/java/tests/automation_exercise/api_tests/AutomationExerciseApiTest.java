...
public class AutomationExerciseApiTest extends BaseApiRequest {
    ...
    public void GetAllProductsList() {
        ...
        Assert.assertEquals(
                productsList.getProductsList().jsonPath().getString("products[0].name"), "Blue Top");
    }
    ...
    public void PostToAllProductsList() {
        ...
        Assert.assertEquals(
                productsList.postProductsList("").jsonPath().getString("responseCode"), "405");
        Assert.assertEquals(
                productsList.postProductsList("").jsonPath().getString("message"),
